...
router.post('/', validate(createProjectGroupSchema), projectGroupsController.createProjectGroup);
router.get('/:groupId', projectGroupsController.getProjectGroup);
router.put('/:groupId', validate(updateProjectGroupSchema), projectGroupsController.updateProjectGroup);
router.delete('/:groupId', projectGroupsController.deleteProjectGroup);
router.post('/:groupId/members', validate(addProjectGroupMemberSchema), projectGroupsController.addMember);
