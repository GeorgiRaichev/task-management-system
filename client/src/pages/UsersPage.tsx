...
import { UserRole, type User, type UserRole as UserRoleType } from '../features/auth/types';
import {
...
import { canCreateUser, canDeleteUser, canEditUser } from '../utils/permissions';
...
export default function UsersPage() {
    ...
    return (
        <Stack spacing={3}>
                    ...
                    <DialogContent>
                        <Stack spacing={2.5} sx={{ mt: 1 }}>
                            ...
                            >
                                ...
                                <MenuItem value="false">{translate('inactiveAccount')}</MenuItem>
                            </TextField>
                        </Stack>
                    </DialogContent>
            ...
            <Dialog open={Boolean(userToDelete)} onClose={handleCloseDelete} fullWidth maxWidth="xs">
